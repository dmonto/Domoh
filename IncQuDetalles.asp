...
Function CasaDetalles(vIdioma, vId, vModo, vFotos, vSeq)
	...
	s=s & "</div>"
	s=s & "<div class=manicon><a title='Mostrar Entero' href=# id='bloquea" & vSeq & "'><img src=http://domoh.com/images/EyeAd.jpg /></a>"
	s=s & "<a title='No Me Interesa' href=# id='quita" & vSeq & "'><img src=http://domoh.com/images/Delete.png style='height: 30px' /></a></div>"
