...
' ****************************************************
' Change the value of the variable below to the pathname of a directory with write permissions, for example "C:\Inetpub\wwwroot"
  Dim uploadsDirVar
  uploadsDirVar = Server.MapPath("fotos/") 
' ****************************************************

' Note: this file uploadTester.asp is just an example to demonstrate the capabilities of the freeASPUpload.asp class. There are no plans
...
%>
    ...
    File 4: <input name=attach4 type=file size=35><br><br> 
    ...
    <select name=list_values class=TextBox multiple><option value='first'> First</option><option value='second'> Second</option><option value='third' > Third</option></select><br>
...
function TestEnvironment()
    ...
    if not fso.FolderExists(uploadsDirVar) then
        TestEnvironment = "<b>Folder " & uploadsDirVar & " does not exist.</b><br>The value of your uploadsDirVar is incorrect. " & _
    ...
    If Err.Number<>0 then
        TestEnvironment = "<B>Folder " & uploadsDirVar & " does not have write permissions.</b><br>The value of your uploadsDirVar is incorrect. " & _
            "Open uploadTester.asp in an editor and change the value of uploadsDirVar to the pathname of a directory with write permissions."
        exit function
    end if
    Err.Clear
...
<br><br>
<div >Upload files to your server</div>
<%
Dim diagnostics
...
<div >Powered by <A HREF="http://www.freeaspupload.net/" >Free ASP Upload</A></div>
...
<tr><td align=center>
	...
	<tr><td align=center nowrap>
		<font ><b>Rated:</b> <a href="http://www.Aspin.com/func/review?id=5380510"><img src=http://ratings.Aspin.com/getstars?id=5380510 border=0></a>
		<font ><br>by <a href="http://www.Aspin.com">Aspin.com</a> users<br></font></font>
	</td></tr><tr nowrap><form action="http://www.Aspin.com/func/review/write?id=5380510" method=post><td align=center>
		<font >What do you think?</font><br>
