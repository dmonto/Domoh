...
Class ASPForm
  ...
  '--- if you want to upload bigger files, please register ScriptUtilities and Huge-ASP upload at http://www.motobit.com/help/scptutl/lc2.htm
...
Class cFormFields
	...
	Private Sub Class_Initialize()
		dim vHelp()
		'--- I do not know why, but some of VBS verrsions declares m_Items and m_Keys as Empty, not as Variant() - see class variables.
...
Function RSBinaryToString(xBinary)
	...
	'--- This function converts binary data (VT_UI1 | VT_ARRAY or MultiByte string) to string (BSTR) using ADO recordset
